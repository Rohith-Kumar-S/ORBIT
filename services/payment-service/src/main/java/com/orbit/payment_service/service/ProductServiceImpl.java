...
import com.orbit.payment_service.dao.ProductServiceRepo;
import com.orbit.payment_service.dao.SellerServiceRepo;
import com.orbit.payment_service.mapper.ProductServiceMapper;
...
public class ProductServiceImpl implements ProductServiceInterface{
	...
	public Product getProduct(String id, Integer sellerId) {
		...
		Optional<com.orbit.payment_service.model.Product> product_opt = this.productServiceRepo.findByIdAndSellerId(id, sellerId);
	...
	public Page<Product> getProductbyTitle(String title, Integer sellerId, String sortBy, String sortDirection, Integer pageNumber, Integer productCount) {
		...
		Page<com.orbit.payment_service.model.Product> productsPageModel = this.productServiceRepo.findByTitleAndSellerId(title, sellerId, pageable) ;
		Page<Product> productsView = productsPageModel.map(this.productServiceMapper::mapProductModelToView);
		return productsView;
	}

	@Override
	public List<com.orbit.payment_service.view.Product> getAllProductsByIds(List<String> productIds) {
		List<com.orbit.payment_service.model.Product> products = this.productServiceRepo.findAllById(productIds);
